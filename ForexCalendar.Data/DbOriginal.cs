...
namespace Net.Code.ADONet
{
    ...
    public class Db : IDb
    {
        ...
        public static Db FromParameters(string inputConnectionString, string inputProviderName)
        {
            var connectionString = inputConnectionString;
            var providerName = inputProviderName;
            return new Db(inputConnectionString, inputProviderName);
        }
