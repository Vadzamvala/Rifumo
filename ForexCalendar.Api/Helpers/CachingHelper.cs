...
namespace ForexCalendar.Api.Helpers
{
    public static class CachingHelper
    {
        private static IEnumerable<TEntity> GetFromCache<TEntity>(string key, Func<IEnumerable<TEntity>> valueFactory) where TEntity : class
        {
